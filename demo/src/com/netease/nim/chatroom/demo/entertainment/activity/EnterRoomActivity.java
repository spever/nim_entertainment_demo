...
public class EnterRoomActivity extends TActivity implements View.OnClickListener{
    ...
    private void joinRoom() {
        ...
        ChatRoomHttpClient.getInstance().studentEnterRoom(DemoCache.getAccount(), roomIdEdit.getText().toString(), new ChatRoomHttpClient.ChatRoomHttpCallback<String>() {
            @Override
            public void onSuccess(String s) {
                AudienceActivity.start(EnterRoomActivity.this, roomIdEdit.getText().toString(), s);
                finish();
            }
            ...
            public void onFailed(int code, String errorMsg) {
                if (code == -1) {
                    Toast.makeText(EnterRoomActivity.this, "无法连接服务器, code=" + code, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(EnterRoomActivity.this, "观众进入房间失败, code=" + code, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
